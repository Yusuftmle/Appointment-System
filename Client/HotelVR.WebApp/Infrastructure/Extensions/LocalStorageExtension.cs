...
namespace HotelVR.WebApp.Infrastructure.Extensions
{
    public static class LocalStorageExtension
    {
        ...
        public static string GetEmail(this ISyncLocalStorageService localStorageService)
        {
            return localStorageService.GetItem<string>(Email);
        }
        public static async Task<string> GetEmail(this ILocalStorageService localStorageService)
        {
            return await localStorageService.GetItemAsync<string>(Email);
        }
        ...
        // Sync Set
        public static void SetEmail(this ISyncLocalStorageService localStorageService, string email)
        {
            localStorageService.SetItem(Email, email);
        }
        // Async Set
        public static async Task SetEmail(this ILocalStorageService localStorageService, string email)
        {
